...
import { ChatAttachment, OrchestrationItemProvenance } from "@t3tools/contracts";
    ...
    execute: (row) => {
      ...
      return sql`
        ...
        VALUES (
          ...
          ${row.isStreaming ? 1 : 0},
          ${row.provenance !== undefined ? JSON.stringify(row.provenance) : null},
        ...
        DO UPDATE SET
          ...
          timeline_order_key = excluded.timeline_order_key,
