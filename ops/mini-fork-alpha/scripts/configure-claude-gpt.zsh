...
: "${MINI_FORK_ALPHA_CLAUDE_CLI_PATH:?Missing MINI_FORK_ALPHA_CLAUDE_CLI_PATH}"
: "${MINI_FORK_ALPHA_CLAUDE_CLI_SHA256:?Missing MINI_FORK_ALPHA_CLAUDE_CLI_SHA256}"
: "${MINI_FORK_ALPHA_CLAUDE_GPT_HOME_PATH:?Missing MINI_FORK_ALPHA_CLAUDE_GPT_HOME_PATH}"
require_absolute_path "MINI_FORK_ALPHA_CLAUDE_CLI_PATH" "$MINI_FORK_ALPHA_CLAUDE_CLI_PATH"
require_absolute_path "MINI_FORK_ALPHA_CLAUDE_GPT_HOME_PATH" "$MINI_FORK_ALPHA_CLAUDE_GPT_HOME_PATH"
[[ "$MINI_FORK_ALPHA_CLAUDE_CLI_SHA256" =~ '^[0-9a-f]{64}$' ]] || fail "Configured Claude CLI SHA-256 must be lowercase hexadecimal."

canonical_claude_cli_path="$(canonical_path "$MINI_FORK_ALPHA_CLAUDE_CLI_PATH")"
...
[[ "$actual_claude_cli_sha256" == "$MINI_FORK_ALPHA_CLAUDE_CLI_SHA256" ]] || fail "Configured Claude CLI SHA-256 does not match its canonical executable."
...
"$MINI_FORK_ALPHA_NODE_BIN" "$release/apps/server/dist/bin.mjs" mini configure-claude-gpt \
  --base-dir "$MINI_FORK_ALPHA_DATA_DIR" \
  --claude-cli-path "$canonical_claude_cli_path" \
  --claude-cli-sha256 "$MINI_FORK_ALPHA_CLAUDE_CLI_SHA256" \
  --claude-home-path "$MINI_FORK_ALPHA_CLAUDE_GPT_HOME_PATH" \
  --gateway-key-fd 0
